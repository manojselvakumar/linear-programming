...
# Gurobi is an optimization solver that is available for a number of programming languages.
# While the full version of Gurobi requires a commercial license, you can get an academic or online course
# license to run a limited version for free.

# Create a list of workers and shifts
shiftList = ['Monday1', 'Monday2', 'Tuesday1', 'Tuesday2', 'Wednesday1', 'Wednesday2', 'Thursday1', 'Thursday2', 'Friday1', 'Friday2', 'Saturday1', 'Saturday2', 'Sunday1', 'Sunday2']
...
# Create the shell of our model
model = Model('Workers_Scheduling')
...
shiftReq = model.addConstrs(((x.sum('*', s) == shiftRequirements[s] for s in shiftList)), name='shiftRequirement')
